        ...
        <Row>
          ...
          <Col xs={24} sm={22} md={20} lg={18} xl={16}>
            ...
            <Content>
              ...
              knowledge, the Quran holds a paramount place in the lives of
              Muslims around the world. It serves as a beacon of light, offering
              moral and spiritual direction, and is fundamental to the Islamic
              faith and way of life. Our mission is to provide a comprehensive
              and immersive learning experience that deepens students'
              connection to the Quran, enhances their recitation skills, and
            ...
            <ol>
              ...
              <Content>
                - This course delves into the rules of Tajweed, the art of
                Quranic recitation. Students will learn the intricate
                regulations governing pronunciation, ensuring they recite the
                Quran with the utmost precision and beauty.
              </Content>
              ...
              <Content>
                ...
                Quranic recitation, offering students a rich understanding of
                the variations and nuances in recitation traditions.
              </Content>
              ...
              <Content>
                - This course focuses on translating the Quran from Arabic to
                Urdu and English, enabling students to grasp the meanings and
                convey them accurately in their native tongue.
              </Content>
              <Link to="/tafseer-course">
                <List>Tafseer Course</List>
              </Link>
              <Content>
                - In this course, students engage in an in-depth study of
                Quranic exegesis, exploring the historical, linguistic, and
                contextual interpretations of the Quran's verses to gain a
                comprehensive understanding of its messages.
              </Content>
              <Space />
              <Content>
